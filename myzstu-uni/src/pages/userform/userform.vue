	...
	<view>
		...
		<view class="container">
		  <view class='info-a'> 
		    ...
		    <input v-model="sid" type="number" length="13" focus="ture" placeholder="请输入你的学号" placeholder-class='font-size: 34rpx;'/>
		  </view>
		  <view class='info-a'>
		    <text space="emsp">教务系统密码：</text>
		    <input type="text" password="true" v-model="edupw" placeholder="默认为身份证号后六位" placeholder-class='font-size: 34rpx;'/>
		  </view>
		  <view class='info-a'> 
		    <text  space="emsp"> 校园卡密码：</text>
		    <input type="number" password="true" v-model="ecardpw" placeholder="默认为身份证号后6位" placeholder-class='font-size: 34rpx;' length="6"/>
		  </view>
		  <view class='info-a'> 
		    <text  space="emsp">图书馆密码：</text>
		    <input type="text" password="true" v-model="libpw" placeholder="默认为身份证号后6位"  placeholder-class='font-size: 34rpx;'/>
		  </view>
		  <view class='info-b'>
		    <text space="emsp">认证中心密码：</text>
		    <input type="text" password="true" v-model="ssopw" placeholder="默认为身份证号后六位" placeholder-class='font-size: 34rpx;'/>
		  </view>
		  <button @tap="saveInfo" id="savebtn" type="primary" ><text space="emsp">确 认</text></button>
		  <view class="tip">
		    <p>温馨提示：</p>
